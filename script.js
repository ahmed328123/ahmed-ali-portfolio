...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    ...
    projectCards.forEach((card) => {
      ...
      card.addEventListener("mousemove", (event) => {
        ...
        const rotateY =
          ((x / rect.width) - 0.5) * 2.2;

        const rotateX =
          ((y / rect.height) - 0.5) * -2.2;
  ...
  /* =======================================================
     Small Background Parallax
     ======================================================= */

  const background =
    document.querySelector(".page-bg");
    ...
    document.addEventListener(
      ...
      (event) => {
        ...
        background.style.transform =
          `translate(${x * -5}px, ${y * -5}px) scale(1.02)`;
  ...
  console.log(
    "Manual Testing • Automation Testing • Playwright • Selenium • API • CI/CD"
  );
